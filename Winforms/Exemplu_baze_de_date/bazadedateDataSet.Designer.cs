...
namespace Exemplu_baze_de_date {
    ...
    public partial class bazadedateDataSet : global::System.Data.DataSet {
        ...
        public partial class EleviDataTable : global::System.Data.TypedTableBase<EleviRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EleviRow AddEleviRow(string Nume, string Prenume, string CNP, string Email, string Adresa) {
        ...
        public partial class EleviRow : global::System.Data.DataRow {
            ...
            public string CNP {
                get {
                    try {
                        return ((string)(this[this.tableElevi.CNPColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'CNP\' in table \'Elevi\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableElevi.CNPColumn] = value;
                }
            }
            ...
            public bool IsCNPNull() {
                return this.IsNull(this.tableElevi.CNPColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetCNPNull() {
                this[this.tableElevi.CNPColumn] = global::System.Convert.DBNull;
            }
...
namespace Exemplu_baze_de_date.bazadedateDataSetTableAdapters {
    ...
    public partial class EleviTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Elevi] ([Id], [Nume], [Prenume], [CNP], [Email], [Adresa]) VAL" +
                "UES (@Id, @Nume, @Prenume, @CNP, @Email, @Adresa);\r\nSELECT Id, Nume, Prenume, CN" +
                "P, Email, Adresa FROM Elevi WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Elevi] SET [Id] = @Id, [Nume] = @Nume, [Prenume] = @Prenume, [CNP] = @CNP, [Email] = @Email, [Adresa] = @Adresa WHERE (([Id] = @Original_Id) AND ((@IsNull_Nume = 1 AND [Nume] IS NULL) OR ([Nume] = @Original_Nume)) AND ((@IsNull_Prenume = 1 AND [Prenume] IS NULL) OR ([Prenume] = @Original_Prenume)) AND ((@IsNull_CNP = 1 AND [CNP] IS NULL) OR ([CNP] = @Original_CNP)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Adresa = 1 AND [Adresa] IS NULL) OR ([Adresa] = @Original_Adresa)));
SELECT Id, Nume, Prenume, CNP, Email, Adresa FROM Elevi WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Exemplu_baze_de_date.Properties.Settings.Default.cs;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Nume, Prenume, CNP, Email, Adresa FROM dbo.Elevi";
        ...
        public virtual int Fill(bazadedateDataSet.EleviDataTable dataTable) {
        ...
        public virtual bazadedateDataSet.EleviDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            bazadedateDataSet.EleviDataTable dataTable = new bazadedateDataSet.EleviDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(bazadedateDataSet.EleviDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Nume, string Original_Prenume, string Original_CNP, string Original_Email, string Original_Adresa) {
        ...
        public virtual int Insert(int Id, string Nume, string Prenume, string CNP, string Email, string Adresa) {
        ...
        public virtual int Update(int Id, string Nume, string Prenume, string CNP, string Email, string Adresa, int Original_Id, string Original_Nume, string Original_Prenume, string Original_CNP, string Original_Email, string Original_Adresa) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nume, string Prenume, string CNP, string Email, string Adresa, int Original_Id, string Original_Nume, string Original_Prenume, string Original_CNP, string Original_Email, string Original_Adresa) {
            return this.Update(Original_Id, Nume, Prenume, CNP, Email, Adresa, Original_Id, Original_Nume, Original_Prenume, Original_CNP, Original_Email, Original_Adresa);
        }
    }
