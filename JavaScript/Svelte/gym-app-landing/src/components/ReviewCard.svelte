...
<div class={"flex flex-col gap-2 w-full max-w-[500px] mx-auto relative" +
    (
        ...
        <div class="flex relative">
            <div class={"absolute rounded-full  bg-white aspect-square hidden "
        + "md:grid place-items-center h-4 top-0 " + (
            index% 2 === 0 ? 'right-0 -mr-8 translate-x-1/2 ' : 
            'left-0 -ml-8 -translate-x-1/2'
        )}>
            <div class="rounded-full bg-slate-950 aspect-square 
            h-2"/>
            </div>
    ...
    <div class="flex items-center flex-wrap gap-2 text-xs sm:text-sm mb-4">
        {#each reviewItem.features as feature}
            <div class="p-1 py-0.5 rounded-md border border-solid
